let individualButton = document.getElementById('individual-section');
let businessButton = document.getElementById('bisness-section');
let depositCard = document.getElementById('deposit-card');
